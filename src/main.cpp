...
void getGFXInfo(std::ostream &outputStream)
{
    outputStream<<"GL Vendor "<<glGetString(GL_VENDOR)<<std::endl;
    outputStream<<"GL Renderer "<<glGetString(GL_RENDERER)<<std::endl;
    outputStream<<"GL Version "<<glGetString(GL_VERSION)<<std::endl;
    outputStream<<"GLSL Version "<<glGetString(GL_SHADING_LANGUAGE_VERSION)<<std::endl;
    outputStream<<"Extensions "<<std::endl;
    GLint noExtensions;
    glGetIntegerv(GL_NUM_EXTENSIONS,&noExtensions);
    for(int i=0;i<noExtensions;i++)
    {
        outputStream<<glGetStringi(GL_EXTENSIONS,i)<<std::endl;
    }
